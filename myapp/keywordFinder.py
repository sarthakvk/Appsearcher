...
class key_man ( object ) :
    ...
    def keyword_finder ( self ) :
        ...
        try :
            ...
            keywords.append ( data.select_one ( 'meta[property="og:description"]' ) [ 'content' ] )
    ...
    def related_urls ( self , keywords ) :
        ...
        for keyword in keywords :
            ...
            key_list = Keyword.objects.filter ( name = keyword ).exclude ( url = self.url ).values ( 'url' )
    ...
    def recommender ( self, dic ) :
        ...
        return recom  # list of recommended keywords | format: list of dictionary(key: name)
